...
public class ImproveLock implements Lock {
	...
	private static final String ZOOKEEPER_IP_PORT = "192.168.46.160:2181,192.168.46.161:2181,192.168.46.162:2181";
	private static final String LOCK_PATH = "/LOCK";

	private ZkClient client = new ZkClient(ZOOKEEPER_IP_PORT, 1000, 5000, new SerializableSerializer());
